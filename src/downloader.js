...
var Downloader = {
    ...
    interface: {
        ...
        get: function(name,url, md5) {
            ...
            return Downloader.load(name,url, md5);
        },
        /**
       ...
       * }
        ...
        getMultipleFiles: function(list) {
            ...
            for (var i = 0; i < list.length; i++) {
                ...
                Downloader.load(fileObject.name,fileObject.url, fileObject.md5);
            }
        },
        abort: function() {
            Downloader.abort();
